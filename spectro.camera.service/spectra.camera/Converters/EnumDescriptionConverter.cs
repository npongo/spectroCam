...
//            enums.Add("K20A", typeof(k20));
//            enums.Add("K22A", typeof(k22));
...
//            enums.Add("status", typeof(status));
//            enums.Add("STATUS", typeof(status)); 
...
//            DisplayAttribute attrib  = fieldInfo.GetCustomAttributes(false).FirstOrDefault(a => a is DisplayAttribute) as DisplayAttribute;
...
//        private string GetEnumDescription(object value, string enumer)
//        {
//            try
//            {
//                Enum enumObj;
//                var type = enums[enumer];
//                if (type != null)
//                {
//                    enumObj = (Enum.Parse(type, value.ToString(), true)) as Enum;

...
namespace npongo.wpf.simMetrics.SimMetricsMetricUtilities
{
    ...
    sealed public class JaccardSimilarity : AbstractStringMetric {
        ...
        /// </summary>
        public override string LongDescriptionString { get { return "Implements the Jaccard Similarity algorithm providing a similarity measure between two strings"; } }

        /// <summary>
        /// returns the string identifier for the metric .
        /// </summary>
        public override string ShortDescriptionString { get { return "JaccardSimilarity"; } }
    }
}
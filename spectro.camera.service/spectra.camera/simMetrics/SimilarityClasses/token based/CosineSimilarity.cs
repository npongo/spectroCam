...
namespace npongo.wpf.simMetrics.SimMetricsMetricUtilities
{
    ...
    sealed public class CosineSimilarity : AbstractStringMetric {
        /// <summary>
        /// constructor
        /// </summary>
        ...
        /// </summary>
        double estimatedTimingConstant = 3.833714e-007F;
            ...
            if ((firstWord != null) && (secondWord != null)) {
                if (tokenUtilities.CreateMergedSet(tokeniser.Tokenize(firstWord), tokeniser.Tokenize(secondWord)).Count > 0) {
                    return
                        ...
                        (Math.Pow(tokenUtilities.FirstSetTokenCount, 0.5) * Math.Pow(tokenUtilities.SecondSetTokenCount, 0.5));
                }
            }
            return 0.0;
        }
        ...
        public override string LongDescriptionString {
            get {
                return
                    "Implements the Cosine Similarity algorithm providing a similarity measure between two strings from the angular divergence within term based vector space";
            }
        }
        ...
        /// </summary>
        public override string ShortDescriptionString { get { return "CosineSimilarity"; } }
    }
}
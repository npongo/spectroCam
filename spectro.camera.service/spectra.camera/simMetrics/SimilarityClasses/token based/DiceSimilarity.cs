...
namespace npongo.wpf.simMetrics.SimMetricsMetricUtilities
{
    ...
    sealed public class DiceSimilarity : AbstractStringMetric {
        /// <summary>
        /// constructor
        /// </summary>
        ...
        /// </summary>
        double estimatedTimingConstant = 3.445714e-007F;
        ...
        /// </summary>
        public override string ShortDescriptionString { get { return "DiceSimilarity"; } }
    }
}
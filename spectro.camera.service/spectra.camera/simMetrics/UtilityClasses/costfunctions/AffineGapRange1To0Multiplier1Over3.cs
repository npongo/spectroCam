...
namespace npongo.wpf.simMetrics.SimMetricsUtilities
{
    ...
    sealed public class AffineGapRange1To0Multiplier1Over3 : AbstractAffineGapCost {
        ...
        /// </summary>
        public override double MaxCost { get { return 1.0; } }

        /// <summary>
        /// returns the minimum possible cost.
        /// </summary>
        public override double MinCost { get { return 0.0; } }

        /// <summary>
        /// returns the name of the cost function.
        /// </summary>
        public override string ShortDescriptionString { get { return "AffineGapRange1To0Multiplier1Over3"; } }
    }
}